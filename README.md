...
- Call the navigate method anywhere in the code
  - The react-router only provide a navigate method after the component is created.
  - The core of the oh-router has nothing to do with Vue or React, so the navigate method that can be called anywhere.
